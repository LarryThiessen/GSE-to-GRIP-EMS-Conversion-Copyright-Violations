...
WN.currentNotes = {
    version = "2.4.6",
    title = "v2.4.6: Undo after switching version no longer changes the wrong version",
    sections = {
        {
            heading = "Fixed",
            items = {
        ...
        },
        {
            ...
            items = {
                "Release at max, the third Hold While Channeling option added in v2.4.0, ends the empower at the first rank instead of at maximum on at least one tester's client, on every press, with nothing on screen to say so. It does not reproduce on the development client and the cause is still open. If your empowered casts are ending early, set that version back to Hold cursor.",
            },
        },
    },
}
