...
An investigation into whether the community site **lazygrip.net** hosts converted copies of these sequences returned **no matches** — the sequences checked were other authors' own GRIP-native builds. That angle is deliberately excluded from the complaint; do not include it.
