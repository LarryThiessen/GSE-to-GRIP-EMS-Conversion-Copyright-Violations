...
WN.currentNotes = {
    version = "1.9.1",
    title = "v1.9.1 -- Tempo Advisor & Interleave",
    sections = {
        {
            heading = "Tempo Advisor (Faster/Slower)",
            items = {
                "Per-sequence click rate analysis -- tells you when you're pressing too fast or slow",
                "Movable overlay with live CPS, recommended MS, and confidence level",
                "Learns from your play data after 30 samples (theory + empirical blend)",
                "Audio alerts when your tempo drifts off the mark",
            },
        },
        {
            heading = "Interleave / Weave",
            items = {
                "Weave a spell every N steps -- set interval on any Action node",
                "Works inside Loop blocks, compiles at save time",
                "Detail pane shows interleave toggle and interval spinner",
            },
        },
        {
            heading = "Import & Export",
            items = {
                "Checksum validation catches corrupted import strings",
                "Sequence disable toggle -- import dormant sequences without activating",
                "Human-readable text export for forum and Discord posts",
                "/gems resetui resets window position and size",
            },
        },
    },
}
